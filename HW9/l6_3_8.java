...
public static boolean checkRhombus(Quadrangle quadrangle){
    ...
    public static List<Quadrangle> generateArr() throws WrongSideException {
    ...
    public static void main(String[] args) throws WrongSideException {
        ...
        try{
            quadrangles.add(new Square(new Point(0, 0), new Point(0, 0), new Point(0, 0),
                    new Point(0, 0)));
