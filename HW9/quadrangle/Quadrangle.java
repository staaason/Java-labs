...
public  class Quadrangle {
    ...
    public Quadrangle(Point a, Point b, Point c, Point d) throws WrongSideException{
        try{
            this.a = a;
            this.b = b;
            this.c = c;
            ...
            if(diagonal1 == 0 || diagonal2 == 0){
                throw new WrongSideException("Wrong parameters, length of one  side is 0", "Wrong parameters");
            }
